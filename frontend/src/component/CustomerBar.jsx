...
const pages = ['Home','Payments', 'Order details']; // Change the display names
const settings = [
...
function ResponsiveAppBar() {
  ...
  {pages.map((page, index) => (
    <Button
      key={index}
      component={Link}
      to={page === 'Payments' ? '/cpayments' : (page === 'Order details' ? '/orders' : (page === 'Home' ? '/cushome' : `/${page.toLowerCase()}`))}
